...
public:
    ...
    ExecutionEngineAdvice() : Advice(AdviceType(PrimaryAdviceType::SOFTWARE_EXECUTION_ENGINE,
                   ...
                   _file_advice_map() {}
    ExecutionEngineAdvice(const ExecutionEngineAdvice& other): Advice(other), _cpu_cores_available(other._cpu_cores_available),
                                                               _gpus_available(other._gpus_available), _memory_available(other._memory_available),
                                                               _read_distribution(other._read_distribution),
                                                               _write_distribution(other._write_distribution), _access_pattern(other._access_pattern),
