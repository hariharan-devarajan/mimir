...
namespace mimir {
    ...
    public:
        ...
        WorkflowAdvice(const WorkflowAdvice& other): Advice(other), _num_cpu_cores_used(other._num_cpu_cores_used),
                                                     _num_gpus_used(other._num_gpus_used), _num_apps(other._num_apps),
                                                     _application_file_dag(other._application_file_dag), _independent_files(other._independent_files),
                                                     _shared_files(other._shared_files), _io_size_mb(other._io_size_mb), _per_io_data(other._per_io_data),
                                                     _per_io_metadata(other._per_io_metadata), _ts_distribution(other._ts_distribution),
                                                     _interfaces_used(other._interfaces_used), _file_access_pattern(other._file_access_pattern),
