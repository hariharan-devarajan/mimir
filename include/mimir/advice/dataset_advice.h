...
namespace mimir {
    ...
    public:
        ...
        DatasetAdvice() : Advice(AdviceType(PrimaryAdviceType::DATA_DATASET,
                          ...
                          _write_distribution(), _file_size_distribution(), _per_io_data(), _per_io_metadata() {}

        DatasetAdvice(const DatasetAdvice& other): Advice(other), _format(other._format), _size_mb(other._size_mb),
                                                   _num_files(other._num_files), _io_amount_mb(other._io_amount_mb),
                                                   _runtime_minutes(other._runtime_minutes), _read_distribution(other._read_distribution),
                                                   _write_distribution(other._write_distribution), _file_size_distribution(other._file_size_distribution),
