...
namespace mimir {
    ...
    public:
        ...
        FileOperationAdvice() : Advice(AdviceType(PrimaryAdviceType::JOB_IO_OPERATION,
                                                  OperationAdviceType::NO_OP)), _offset(),
                                _size(), _interface_used(), _runtime_minutes() {}
        FileOperationAdvice(const FileOperationAdvice& other): Advice(other), _offset(other._offset),
                                                               _size(other._size),
